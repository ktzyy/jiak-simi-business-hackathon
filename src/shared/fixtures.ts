...
export const fixtureCart: CartRequest = { restaurantId: fixtureMenu.restaurantId, menuId: fixtureMenu.id, menuVersion: 1, lines: [{ dishId: fixtureMenu.dishes[0].id, quantity: 2, optionIds: [fixtureMenu.dishes[0].modifierGroups[0].options[1].id] }] };
export const fixtureQuote: Quote = { restaurantId: fixtureMenu.restaurantId, menuId: fixtureMenu.id, menuVersion: 1, currency: "SGD", lines: [{ dishId: fixtureMenu.dishes[0].id, name: "Test noodles", quantity: 2, options: [fixtureMenu.dishes[0].modifierGroups[0].options[1]], unitPriceCents: 550, lineTotalCents: 1100 }], totalCents: 1100 };
export const fixtureTicket: Ticket = { id: "00000000-0000-4000-8000-000000000007", createdAt: "2026-09-13T03:00:00.000Z", source: "web", status: "received", paymentStatus: "unpaid", cart: fixtureQuote };
