...
const cart: CartRequest = { restaurantId: DEMO_MENU.restaurantId, menuId: DEMO_MENU.id, menuVersion: DEMO_MENU.version, lines: [{ dishId: DEMO_MENU.dishes[0].id, quantity: 2, optionIds: [] }, { dishId: DEMO_MENU.dishes[1].id, quantity: 1, optionIds: [] }] };
const quote = previewQuote(DEMO_MENU, cart.lines);
const key = "d98b97c0-7004-4587-8ce0-5804c0474a1a";
const ticket: Ticket = { id: "70762012-88c6-4f0a-95b4-1db4ca4195df", createdAt: "2026-09-13T01:00:00.000Z", source: "web", status: "received", paymentStatus: "unpaid", cart: quote };
